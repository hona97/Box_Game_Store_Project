...
<head>
    ...
    - BoxGame Icon
  -->
    <link rel="shortcut icon" href="<?php echo e(asset('assets_home/images/boxlogo1.png')); ?>">
  ...
  -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets_home/css/sweetalert.css')); ?>">
  ...
  -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets_home/css/search.css')); ?>">
    <!--
    - livewire
    -->
        ...
        <div class="header-top" data-header>
            <div class="container">
                ...
                <div class="header-left">
                    <a href="<?php echo e(route('homeuser')); ?>" class="logo">
                        <img src="<?php echo e(asset('assets_home/images/boxlogo.png')); ?>" alt="">
                    </a>
                    <ul class="header-left-list">
                        <li>
                            <a href="<?php echo e(route('homeuser')); ?>" class="hll-link">STORE</a>
                        </li>
                        <li>
                    ...
                    <div class="header-actions">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <button class="header-action-btn btn-user-login">
                                ...
                                <span style="color: var(--text-white);"><?php echo e(Auth::user()->userID); ?></span>
                                <img class="" src="<?php echo e(asset(Auth::user()->image)); ?>" alt="">
                                <ul class="user-list">
                                    <li>
                                        <a href="<?php echo e(route('accountsettings')); ?>" class="user-list-link first">account</a>
                                    </li>
                                    <li>
                                        <a href="" class="user-list-link">wish list</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('logout')); ?>" class="user-list-link">sign out</a>
                                    </li>
                                </ul>
                            </button>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="header-action-btn btn-user-login">
                                <ion-icon name="person"></ion-icon>
                                <span>sign in</span>
                            </a>

                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="header-action-btn btn-user-register">
                                    REGISTER
                                </a>
                            <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('0XiFakN')) {
    $componentId = $_instance->getRenderedChildComponentId('0XiFakN');
    $componentTag = $_instance->getRenderedChildComponentTagName('0XiFakN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0XiFakN');
} else {
    $response = \Livewire\Livewire::mount('cart-counter');
    $html = $response->html();
    $_instance->logRenderedChild('0XiFakN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <footer class="section footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                ...
                <img src="<?php echo e(asset('assets_home/images/pay.png')); ?>" width="313" height="28"
  ...
  -->
    ...
    - custom js link
  -->
    <script src="<?php echo e(asset('assets_home/js/script.js')); ?>" defer></script>
...
<?php /**PATH D:\New folder\htdocs\Box_Game_Store\resources\views/layouts/home.blade.php ENDPATH**/ ?>