                            ...
                            <?php if($payment->card_name == 'paypal'): ?>
                                <li class="cart_payment1">
                                    ...
                                    <div class="content_cart_payment" <?php echo e($data); ?>>
                                        ...
                                        <a href="<?php echo e(route('processTransaction')); ?>" class="btn_payment">pay</a>                                                   
                                    </div>
                                </li>
                            <?php elseif($payment->card_name == 'vnpay'): ?>
                                <li class="cart_payment1">
                                    ...
                                    <div class="content_cart_payment" <?php echo e($data); ?>>
                                        ...
                                        <form action="<?php echo e(route('vnpayPayment')); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                            ...
                            <?php elseif($payment->card_name == 'momo'): ?>
                                <li class="cart_payment1">
                                    ...
                                    <div class="content_cart_payment" <?php echo e($data); ?>>
                                        ...
                                        <form action="<?php echo e(route('momoPayment')); ?>" method="post">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="content_other_payment" data-paymenthide-hide1>
                                        ...
                                        <div class="saveandpay">
                                            ...
                                            <div class="detailspayment2">
                                                <a href="<?php echo e(route('processTransaction')); ?>">pay</a>
                                            </div>      
                                        </div>                 
                                    </div>
                                </li>
                                ...
                                <li class="other_payment1">
                                    ...
                                    <div class="content_other_payment" data-paymenthide-hide4>
                                        ...
                                        <div class="saveandpay">
                                            ...
                                            <form class="detailspayment2" action="<?php echo e(route('vnpayPayment')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
                                ...
                                <li class="other_payment1">
                                    ...
                                    <div class="content_other_payment" data-paymenthide-hide5>
                                        ...
                                        <div class="saveandpay">
                                            ...
                                            <form class="detailspayment2" action="<?php echo e(route('momoPayment')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
    ...
    <div class="order-summary">
        ...
        <div class="order-list">
            ...
            <div class="order-item">
                <div class="order-img">
                    <img src="<?php echo e(asset("$imageLink")); ?>" alt="">
                </div>
                <div class="oi-details">
                    <span class="item-name"><?php echo e(str_replace('_', ' ', str_replace('__', ': ', $v_content->id))); ?></span>
            ...
            <div class="payment-summary">
                ...
                <div class="order-price">
                    ...
                    <span class="price">-$<?php echo e(number_format($discount, 2, '.', '')); ?></span>
                </div>
                <hr>
                <div class="order-total">
                    <span class="title">Total</span>
                    <span class="price">$<?php echo e(number_format($totalPrice - $discount, 2, '.', '')); ?></span>
                    <?php
        ...
        <div class="place-order tooltip">
            <a href="<?php echo e(URL::to('updateCart/' . $cartId )); ?>">
...
<?php /**PATH D:\New folder\htdocs\Box_Game_Store\resources\views/livewire/check-out-form.blade.php ENDPATH**/ ?>